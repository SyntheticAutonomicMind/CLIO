...
{
    # Simulate caps for minimax-m2.7 on OpenRouter
    my $caps = {
...
# ── Test 4: Provider prefix collision avoidance ──
{
    ...
    # This test verifies that 'minimax/minimax-m2.7' would be
    # misinterpreted as the 'minimax' CLIO provider (the bug),
    # and that using the full model name 'openrouter/minimax/minimax-m2.7'
    # is correctly parsed as provider='openrouter'.

    require CLIO::Providers;

    # Stripped name (what was being passed before the fix):
    my $stripped = 'minimax/minimax-m2.7';
    ...
    my $full = 'openrouter/minimax/minimax-m2.7';
    ...
    is($rest_full, 'minimax/minimax-m2.7', 'OpenRouter model id correctly preserved');
}

# ── Test 5: top_provider field extraction ──
{
    # Simulate OpenRouter API response for minimax/minimax-m2.7
    my $info = {

    ...
    my @sections = (
        ...
        { header => 'ALL COMMANDS',
          rows   => [
            ...
            ['/api set temperature <value>',      'Override sampling temperature (reset, default, off to clear)', 40],
            ['/api set top_p <value>',            'Override top_p sampling (reset, default, off to clear)', 40],
            ['/api set top_k <value>',            'Override top_k sampling (reset, default, off to clear)', 40],

...
```bash
clio --model "openrouter/minimax/minimax-m3 kilo/poolside/laguna-s-2.1 vercel/poolside/laguna-s-2.1" --new
```

Within a session:
```text
/api set model "openrouter/foo kilo/bar"
```
